/*
 *                                                  Mitochondria - ER Contact Points Macro v148
 *                                     
 *                         This macro was designed to work with ND2 images. It may work with other image stacks
 ...
 *                         Colocalization Highlighter - https://imagej.nih.gov/ij/plugins/mbf/
 *                         IsoPhotContour2 - https://github.com/landinig/IJ-IsoPhotContour/blob/main/isophotcontour2.zip
 */
//run("ND to Image6D");
open();
...
setResult("ER Weighted Mean",cellnum-1,erweightedmean);
setResult("Mito Weighted Mean",cellnum-1,mitoweightedmean);
